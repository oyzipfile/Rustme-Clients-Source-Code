...
final class CallbackUtil {
    ...
    private static void registerContextCallback(long userParam, Map<ContextCapabilities, Long> contextUserData) {
        ...
        Long userParam_old = contextUserData.remove((Object)caps);
    ...
    static void unregisterCallbacks(Object context) {
        ContextCapabilities caps = GLContext.getCapabilities((Object)context);
        Long userParam = contextUserParamsARB.remove((Object)caps);
        if (userParam != null) {
            CallbackUtil.deleteGlobalRef(userParam);
        }
        if ((userParam = contextUserParamsAMD.remove((Object)caps)) != null) {
            CallbackUtil.deleteGlobalRef(userParam);
        }
        if ((userParam = contextUserParamsKHR.remove((Object)caps)) != null) {
            CallbackUtil.deleteGlobalRef(userParam);
        }
    }
